                                    ...
                                    <div class="card">
                                        ...
                                        <?php
                                            ...
                                            include_once("../../model/entity/Address.php");
                                                ...
                                                // query products
                                                $stmt = $address->readAll($from_record_num, $records_per_page);
                                                $num = $stmt->rowCount();
                                            if($num>0){
                        ...
                        <div class="modal fade" id="modal-default">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="../service/add_address.php" method="post">
    ...
    $(document).on('click', '#update_submit', function (e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#message').html('<div class="alert alert-success">Địa chỉ đã được cập nhật thành công.</div>');
            ...
            error: function(error) {
                $('#message').html('<div class="alert alert-danger">Có lỗi xảy ra khi cập nhật địa chỉ.</div>');
