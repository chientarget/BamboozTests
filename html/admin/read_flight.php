                                    ...
                                    <div class="d-flex mb-3">
                                            <?php
                                                ...
                                                $search_value=isset($search_term) ? "value='{$search_term}'" : "";
                                                    echo "<input type='text' class='form-control' placeholder='Tìm kiếm chuyến bay...' style='position: relative;' name='id' id='srch-term' required {$search_value} > ";
                        ...
                        if(result==true){
                            $.post('../service/delete_flight.php', {
                                ...
                                setTimeout(function(){
                                    ...
                                    window.location.href = '../admin/flight.php';
                                }, 500);
                            }).fail(function(error) {
